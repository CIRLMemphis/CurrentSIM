...
Radius    = 0.055;%( 0.2/dXY - 0)*dXY/2;   % radius of bead in microns
Distance  = 0.120;                  % shell thickness of bead in microns
DistanceZ = 0.460;
f2 = pointsXYZ(X, Z, dXY, dZ, Radius, Distance, DistanceZ);
Fil_size = 2+1;
sd = 1.5;
