function [ psfpar, psfpari ] = TunablePSFConfigAber( distToCoverslip, wavelength )

if (nargin < 1)
    distToCoverslip = -30;    % distance to cover slip, for a descending axis use a negative value
end

if (nargin < 2)
    wavelength = 0.515;    % distance to cover slip, for a descending axis use a negative value
end
...
Lambda = wavelength;          % wavelength [microns]
% illumination
NAi = 1.4;               % NA/num aperture
Lambdai = wavelength;         % wavelength [microns]
