...
X    = 800;   % discrete lateral size in voxels
Y    = 800;   % discrete lateral size in voxels
Z    = 30;   % discrete axial size in voxels
%M    = 63;    % Experimetal magnification
dXY  = 6.5/37.5; % lateral voxel scaling in microns ---- for 63X lens (6.5/63)....for 60X lens (6.4/63)
dZ   = 1;   % axial voxel scaling in microns
uc    = 2*psfpar.NA/psfpari.v(1);  % cycle/um
phi   = [-0.574057, 16.410422, 32.997532];
offs  = 0;
theta = 0;
omegaXY = [0.3, 0.3, 0.3]*uc; % 0.45*uc;0.9281;
x0      = 0.400;  % in mm
fL1     = 100;  % in mm
fL2     = 250;  % in mm
fMO     = 160/20;
