...
% print(gcf,...
%       "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\GlioForward.png",...
%       '-dpng','-r300');
...
% print(gcf,...
%       "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\GlioForwardFFT.png",...
%       '-dpng','-r300');
...
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\AxialAlign.png",...
      '-dpng','-r300');
...
matObj = matfile(CIRLDataPath + "\Results\071719Glio\201912181933_ExpTunableOptMB071719Glio512x128_3200ms_75mW_Aber5LowNASlits\201912181933_ExpTunableOptMB071719Glio512x128_3200ms_75mW_Aber5LowNASlits.mat");
...
set(gca,'xtick',[],'ytick',[],'title',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\MBRecon.png",...
      '-dpng','-r300');
...
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\FFTPostProcessing.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[],'title',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\PostProcessed.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\PrevsPost.png",...
      '-dpng','-r300');
...
%% GWF results
load('C:\Users\cvan\OneDrive - The University of Memphis\CIRLData\Results\071719Glio\201912181955_ExpTunable071919Glio512x128GWFLowNASlits\201912181955_ExpTunable071919Glio512x128GWFLowNASlits.mat', 'reconOb');
GWFreconOb = reconOb;
...
set(gca,'xtick',[],'ytick',[],'title',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\GWFRecon.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\GWFvsMB.png",...
      '-dpng','-r300');
  
%%
load('C:\Users\cvan\OneDrive - The University of Memphis\CIRLData\Results\071719Glio\201912181955_ExpTunable071919Glio512x128GWFLowNASlits\201912181955_ExpTunable071919Glio512x128GWFLowNASlits.mat', 'retVars');
GWFWF = retVars{2};
GWFWF(GWFWF < 0) = 0;
...
set(gca,'xtick',[],'ytick',[],'title',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\Widefield.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[],'title',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\CleanWidefield.png",...
      '-dpng','-r300');
...
%set(gca,'xtick',[],'ytick',[])
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\CleanWFvsMB.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[]); title('post-processed MB');
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\XYFullCleanWFvsMB.png",...
      '-dpng','-r300');
...
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\XYZoomedCleanWFvsMB.png",...
      '-dpng','-r300');
...
set(gca,'xtick',[],'ytick',[]); title('post-processed MB');
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\XZFullCleanWFvsMB.png",...
      '-dpng','-r300');
...
fh = figure();
fh.WindowState = 'maximized';
subplot(1,2,1); imagesc(squeeze(cleanWF(yBF, xzRegionX, xzRegionZ))' ); axis image; colormap(colorSetting);
set(gca,'xtick',[],'ytick',[]); title('zoomed post-processed WF');
subplot(1,2,2); imagesc(squeeze(cleanRecon(yBF, xzRegionX, xzRegionZ))' ); axis image; colormap(colorSetting);
set(gca,'xtick',[],'ytick',[]); title('zoomed post-processed MB');
print(gcf,...
      "C:\Users\cvan\OneDrive - The University of Memphis\github\cirl\doc\Discussion\120819_NSFReport\pics\Glio0719Aber5LowNASlits\XZZoomedCleanWFvsMB.png",...
      '-dpng','-r300');