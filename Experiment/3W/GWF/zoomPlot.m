function az = zoomPlot(ah, source_pos, target_pos, colorScale)
...
source_rect = rectangle('position', [rect_x, rect_y, rect_w, rect_h], 'linestyle', '-', 'EdgeColor', 'r');
...
set(az, 'xtick', [], 'ytick', []);
set(source_rect, 'linestyle','--', 'Edgecolor', 'r');
box on;
