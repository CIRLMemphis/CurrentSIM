...
RunReconstruction(...
            ...
            'reconArgs',        {"g", "h", "im", "uc", "u", "phi", "offs", "theta", "wD", "dXY", "dZ",-1,A,sigma,1,ones(Y,X,Z),...
                                'FairSIMGreenHn1024_1024_7.mat',[],[]},...[0.98, 1.2]},...
            ...'reconArgs',        {"g", "h", "im", "uc", "u", "phi", "offs", "theta", "wD", "dXY", "dZ",-1,A,sigma,1},...[0.98, 1.2]},...
            ...
            'reportFolder',     CIRLReportPath,...
            'reportFile',       "FairSIMExp3WOptGWFLSECActinFull.tex")