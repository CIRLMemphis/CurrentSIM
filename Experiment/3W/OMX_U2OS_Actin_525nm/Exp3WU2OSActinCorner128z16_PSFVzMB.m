run("Exp3WActinCorner128z16Setup.m");
matFile = CIRLDataPath + "/FairSimData/OMX_U2OS_Actin_525nm_Corner128z16.mat";
...
h  = h(513-128:513+127, 513-128:513+127, 53-16:53+15);
vz = vz(:, :, 53-16:53+15, :);
...
RunReconstruction(...
            ...
            'reportFile',       "Exp3WU2OSActinCorner128z16_PSFVzMB.tex")
