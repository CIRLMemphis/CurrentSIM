...
load(matFile, 'g');
gIn = zeros(size(g,1), size(g,2), size(g,3), 15);
gIn(:,:,:,1)  = g(:,:,:,1,1);
gIn(:,:,:,2)  = g(:,:,:,1,2);
gIn(:,:,:,3)  = g(:,:,:,1,3);
gIn(:,:,:,4)  = g(:,:,:,1,4);
...
thePhiOff = [ theta(1) phi(1) offs(1); ...
              ...
              theta(2) phi(4) offs(2); ...
              theta(2) phi(5) offs(2); ...
              theta(3) phi(1) offs(3); ...
              theta(3) phi(2) offs(3); ...
              theta(3) phi(3) offs(3); ...
              theta(3) phi(4) offs(3); ...
              theta(3) phi(5) offs(3) ];
...
RunReconstruction(...
            ...
            'reconArgs',        {@HotPSFVzForwardModel, ...
                                 ...
                                 "numIt", 1e-4 ,-1, -1, picIn, initInd},...
            ...
            'reportFolder',     CIRLReportPath,...
            'reportFile',       "Exp3WLSECActinPSFVzMBPCDR15_jmDouble_Reg1e4.tex")
