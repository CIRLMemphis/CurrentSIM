...
save(CIRLDataPath + "/Simulation/PyLBFGSB/SimTunableA5Bead100.mat", 'g');
save(CIRLDataPath + "/Simulation/PyLBFGSB/hA5.mat" , 'h');
save(CIRLDataPath + "/Simulation/PyLBFGSB/imA5.mat", 'im');
save(CIRLDataPath + "/Simulation/PyLBFGSB/jmA5.mat", 'jm');
...
save(CIRLDataPath + "/Simulation/PyLBFGSB/SimTunableBead100.mat", 'g');
save(CIRLDataPath + "/Simulation/PyLBFGSB/h.mat" , 'h');
save(CIRLDataPath + "/Simulation/PyLBFGSB/im.mat", 'im');
save(CIRLDataPath + "/Simulation/PyLBFGSB/jm.mat", 'jm');