run("SimTunable11SlitsStarlike512SetupU08.m");
matFile = CIRLDataPath + "/Simulation/Starlike/SimTunable11SlitsStarlike512U08.mat";
...
%% save the noisy data
matFile = CIRLDataPath + "/Simulation/Starlike/SNR10dBSimTun11Slits122StarlikeU08.mat";
save(matFile, '-v7.3', 'g');