...
run("../SimTunable3SlitsStarlike256SetupU06.m");

%% load the collected data (in this case simulated data)
matFile = CIRLDataPath + "/Simulation/Starlike/SNR15dBSimTun3Slits122StarlikeU06.mat";
...
RunReconstruction(...
            ...
            'reportFile',       "SimGWF3Slits122StarSNR15dBU06.tex")