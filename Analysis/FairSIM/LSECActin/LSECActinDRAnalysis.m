...
fh = figure();
fh.WindowState = 'maximized';
subplot(1,4,1); imagesc(FairSIMRes(:, :,round(zBest/2))); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('2D-FairSIM Full');
subplot(1,4,2); imagesc(MBPCObNor (:, :,zBest)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('3D-MBPC Full');
...
fh = figure();
fh.WindowState = 'maximized';
subplot(1,4,1); imagesc(FairSIMRes(512:end, 512:end, round(zBest/2))); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('2D-FairSIM Corner');
subplot(1,4,2); imagesc(MBPCObNor (512:end, 512:end, zBest)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('3D-MBPC Corner');
subplot(1,4,3); imagesc(MBPC7ObNor(512:end, 512:end, zBest)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
...
fh = figure();
fh.WindowState = 'maximized';
subplot(1,4,1); imagesc(FairSIMRes(xyRegionY, xyRegionX,round(zBest/2))); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('Zoomed 2D-FairSIM');
subplot(1,4,2); imagesc(MBPCObNor (xyRegionY, xyRegionX,zBest)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
...
fh = figure();
fh.WindowState = 'maximized';
subplot(3,2,1); imagesc(FairSIMRes(xyRegionY, xyRegionX,round(zBest/2)-1)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('Zoomed 2D-FairSIM');
subplot(3,2,2); imagesc(MBPCObNor (xyRegionY, xyRegionX,zBest-2)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
title('Zoomed 3D-MBPC');
subplot(3,2,3); imagesc(FairSIMRes(xyRegionY, xyRegionX,round(zBest/2))); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
subplot(3,2,4); imagesc(MBPCObNor (xyRegionY, xyRegionX,zBest)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
subplot(3,2,5); imagesc(FairSIMRes(xyRegionY, xyRegionX,round(zBest/2)+1)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');
subplot(3,2,6); imagesc(MBPCObNor (xyRegionY, xyRegionX,zBest+2)); axis image; axis off; caxis(colorScale); colormap(colormapSet); xlabel('x'); ylabel('y');