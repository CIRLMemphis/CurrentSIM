...
expNames = ["201908211658_SimTunableGWFMultiOb",...
            ...
            "201908242248_SimTunableMBMultiOb256PhaseOff"];
...
MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ["True Object", "GWF", "MB 200 Iter", "MB off phase"],...
                                "Comparison of different reconstruction methods when phase is off",...
                                colormapSet, midSlice);
saveas(MethodCompareFig, "TunableOffPhaseComparison.jpg");
