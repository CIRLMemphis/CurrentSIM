...
expNames = ["201909122325_Sim3WMBPCHotMultiOb256Iter200",...
...
MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ...
                                "Model-based with PC method with data reduction for noiseless data",...
                                colormapSet, midSlice, colorScale);
saveas(MethodCompareFig, "3WMBPCDRComparison.jpg");
...
suptitle("x, z profiles of MBPC with data reduction for noiseless data");
saveas(ProfileCompareFig, "3WMBPCDRProfileComparison.jpg");
