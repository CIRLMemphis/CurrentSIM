...
MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ["True Object", "GWF Noiseless", "MB Noiseless", "MBPC Noiseless", "GWF 15dB", "MB 15dB", "MBPC 15dB"],...
                                "Comparison of different methods for noiseless and noisy data",...
                                colormapSet, midSlice, colorScale);
saveas(MethodCompareFig, "3WMethodComparison.jpg");
...
saveas(ProfileCompareFig, "3WNoiselessMethodProfileComparison.jpg");
...
saveas(ProfileCompareFig, "3W15dBMethodProfileComparison.jpg");