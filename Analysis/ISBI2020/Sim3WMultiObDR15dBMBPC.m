...
expNames = ["201909141259_Sim3WMBPCHotMultiOb256SNR15dBIter200",...
            "201909142014_Sim3WMBPCDR7of15HotMultiOb256SNR15dBIter400", ...
            "201909142021_Sim3WMBPCDR5of15HotMultiOb256SNR15dBIter400"];
...
MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ...
                                "Model-based with PC method with data reduction when SNR = 15dB",...
                                colormapSet, midSlice, colorScale);
saveas(MethodCompareFig, "3WMBPCDR15dBComparison.jpg");
...
suptitle("x, z profiles of MBPC with data reduction when SNR = 15dB");
saveas(ProfileCompareFig, "3WMBPCDR15dBProfileComparison.jpg");
