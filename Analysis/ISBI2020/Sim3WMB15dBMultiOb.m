...
expName = '201909131733_Sim3WMBHotMultiOb256SNR15dBIter200';
...
saveas(TrueVsGWF, "3WTrueVsMB15dB.jpg");

[ MSE, SSIM ] = MSESSIM(norReconOb, norOb)

%% different number of iterations
cnt    = 1;
titTxt = ["100 Iter", "200 Iter", "300 Iter", "4000 Iter"];
yScale = [0 1.2];
...
saveas(ProfileCompareFig, "3WMB15dBIterProfile.jpg");
