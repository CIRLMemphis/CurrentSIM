...
expName = '201909121906_Sim3WMBHotMultiOb256Iter200';
...
saveas(TrueVsGWF, "3WTrueVsMB.jpg");
...
suptitle("x, z profiles of different iterations for MB method of noiseless data.");
saveas(ProfileCompareFig, "3WMBNoiselessIterProfile.jpg");
