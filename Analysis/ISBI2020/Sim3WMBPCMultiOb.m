...
expName = '201909122325_Sim3WMBPCHotMultiOb256Iter200';
...
saveas(TrueVsGWF, "3WTrueVsMBPC.jpg");
...
suptitle("x, z profiles of different iterations for MBPC method of noiseless data.");
saveas(ProfileCompareFig, "3WMBPCNoiselessIterProfile.jpg");
...
IterCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ...
                                "Comparison of MBPC results at different number of iterations for noiseless data",...
                                colormapSet, midSlice, colorScale);
saveas(IterCompareFig, "3WMBPCIterComparison.jpg");