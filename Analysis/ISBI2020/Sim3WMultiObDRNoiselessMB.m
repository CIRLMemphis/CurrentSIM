...
MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ...
                                "Model-based method with data reduction for noiseless data",...
                                colormapSet, midSlice, colorScale);
saveas(MethodCompareFig, "3WMBDRComparison.jpg");
...
suptitle("x, z profiles of MB with data reduction for noiseless data");
saveas(ProfileCompareFig, "3WMBDRProfileComparison.jpg");
