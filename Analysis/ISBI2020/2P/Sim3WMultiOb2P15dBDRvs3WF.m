...
expNames = ["201909300042_Sim3WMBHotMultiOb2P256SNR15dBIter200", ...
            ...
            "201910220601_Sim3WMBDR3WFof15HotMultiOb2P256SNR15dBIter400", ...
...
texRet = MSESSIMtoTex(MSE, SSIM, ["MB 15of15", "MB 7of15", "MB 3of15 + WF", "MB 5of15"])

MethodCompareFig = XYXZSubplot( recVars, z2BF, y2BF, ...
                                ["True Object", "MB 15of15", "MB 7of15", "MB 3of15 + WF", "MB 5of15"],...
                                "Comparison of MB method with data reduction for noisy data",...
