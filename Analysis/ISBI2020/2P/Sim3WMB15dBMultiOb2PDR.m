...
expName = '201910011318_Sim3WMBDR5of15HotMultiOb2P256SNR15dBIter400';
load(CIRLDataPath + "\Results\ISBI2020\2P\" + expName + "\" + expName + ".mat",...
...
suptitle('Comparison of the true object and MB2P DR reconstructed image for noisy data');

saveas(TrueVsGWF, "3WTrueVsMBDR2P15dB.jpg");
...
saveas(ProfileCompareFig, "3WMBDR2P15dBIterProfile.jpg");
