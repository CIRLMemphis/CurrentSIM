...
expNames = ["201911251719_Sim3WOptGWFOSSRMultiOb256SNR15dB",...
            ...
            "202004110037_Sim3WMBPCDR7of15HotOSSRMultiOb256SNR15dBIter400"];
iterInd  = [0, 3, 2];
...
texRet = MSESSIMtoTex(MSE, SSIM, ["GWF", "MBPC NoReg", "MBPC DR7"])


%%
MethodCompareFig = OSSRSubplotXZ( recVars, z2BF, y2BF, ...
                                ["True Object", "3D-GWF", "MBPC, 150Iter", "MBPC DR7, 300Iter"],...
