function [Ob, figTits, retVars] = CongOTF2DGWFCore( g, Hn, qn, cn, uc, omegaXY, phiDeg, offsDeg, thetaDeg, wD, dXY, dZ, cutoff, A, sigma, weights, returnVar, GFilter, shouldDouble, inAD)
retVars = {};
figTits = {};
