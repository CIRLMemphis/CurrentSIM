function [Ob, retFig, retVars] = GWF3W3D( g, h, im, uc, omegaXY, phiDeg, offsDeg, thetaDeg, wD, dXY, dZ, cutoff, A, sigma, returnVar, GFilter, inHn, weights)
...
[Ob, figTits, retVars] = GWFCore(g,h,vn,qn,cn,uc,omegaXY,phiDeg,offsDeg,thetaDeg,wD,dXY,dZ,cutoff,A,sigma,weights,returnVar,GFilter,inHn);

% component pictures for fixed theta, variable phi
for lThe = 1:3
    zBF = 7; % zBF  = 1+round(Z/2);
    zBF2 = zBF*2;
    retFig = [];
