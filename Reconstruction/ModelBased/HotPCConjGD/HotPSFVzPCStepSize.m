function curStepSize = HotPSFVzPCStepSize(ForwardModelFct, UpFct, g0, d, xi, h, vz, jmFunc, Nm, xx, yy, zz, dXY, dZ, omegaXY, omegaZ, thetaDeg, phiDeg, offDeg, phizDeg, penalizationParam)
if(nargin < 21)
    penalizationParam = -1;
end
[~, ~, ~, Nthe, Nphi] = size(g0);
